...
const (
	...
	ER_INVALID_ON_UPDATE_CREATE_TIME
	ER_INVALID_ON_UPDATE_UPDATE_TIME
	ER_DDL_DML_COEXIST
...
var ErrorsDefault = map[ErrorCode]string{
	...
	ER_INVALID_DEFAULT_CUR:                 "column '%s' should be CURRENT_TIMESTAMP",
	...
	ER_INVALID_ON_UPDATE_CREATE_TIME:       "Must not contain ON UPDATE clause for '%s' column",
	ER_INVALID_ON_UPDATE_UPDATE_TIME:       "Must contain ON UPDATE clause for '%s' column",
...
var ErrorsChinese = map[ErrorCode]string{
	...
	ER_INVALID_DEFAULT_CUR:                 "列 '%s' 的默认值必须是CURRENT_TIMESTAMP.",
	ER_USERNAME:                            "user name",
	ER_HOSTNAME:                            "host name",
	ER_NOT_VALID_PASSWORD:                  "Your password does not satisfy the current policy requirements.",
	ER_WRONG_STRING_LENGTH:                 "String '%s' is too long for %s (should be no longer than %d).",
	...
	ER_INVALID_ON_UPDATE_CREATE_TIME:       "列 %s' 不能包含ON UPDATE 设置",
	ER_INVALID_ON_UPDATE_UPDATE_TIME:       "列 %s' 必须包含ON UPDATE 设置",
	ER_DDL_DML_COEXIST:                     "DDL can not coexist with the DML for table '%s'.",
	ER_SLAVE_CORRUPT_EVENT:                 "Corrupted replication event was detected.",
	ER_COLLATION_CHARSET_MISMATCH:          "COLLATION '%s' is not valid for CHARACTER SET '%s'",
	ER_NOT_SUPPORTED_ALTER_OPTION:          "Not supported statement of alter option",
...
func (e ErrorCode) String() string {
	...
	case ER_INVALID_DEFAULT_CUR:
		return "er_invalid_default_cur"
	case ER_USERNAME:
		return "er_username"
	case ER_HOSTNAME:
		return "er_hostname"
	...
	case ER_INVALID_ON_UPDATE_CREATE_TIME:
		return "er_invalid_on_update_create_time"
	case ER_INVALID_ON_UPDATE_UPDATE_TIME:
		return "er_invalid_on_update_update_time"
